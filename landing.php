...
<div class="head ">
  ...
  <img class= "bounceIn animated" src="logo3.png"><br>
  <h1 class="bounceIn animated" >YO CABS</h1>

  <p class="bounceIn animated">Experience the best Rides in your city.</p>

   <a href="home1.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle"><span>Lets Ride </span></button></a>
